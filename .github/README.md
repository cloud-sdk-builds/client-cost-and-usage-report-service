...
[`@aws-sdk/client-cost-and-usage-report-service`](https://www.npmjs.com/package/@aws-sdk/client-cost-and-usage-report-service/v/3.1115.0).
...
- @aws-sdk/client-cost-and-usage-report-service v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cost-and-usage-report-service&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-cost-and-usage-report-service&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IrrGM2lgLAQBkBqS6Om69FrCn3hmDOphYownr4FcjlDuYhaucvu8w29sWnqqdsr+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cost-and-usage-report-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1115.0/index.min.mjs": "sha384-IrrGM2lgLAQBkBqS6Om69FrCn3hmDOphYownr4FcjlDuYhaucvu8w29sWnqqdsr+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cost-and-usage-report-service/blob/refs/tags/3.1115.0/LICENSE
```
