...
[`@aws-sdk/client-cost-and-usage-report-service`](https://www.npmjs.com/package/@aws-sdk/client-cost-and-usage-report-service/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eA5+3v/AvB8d0pdADjD9yamd2gpmoHKkNWr/NhzTliU6726D6RCypR+nw5tjpCm+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cost-and-usage-report-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.85.0/index.min.mjs": "sha384-eA5+3v/AvB8d0pdADjD9yamd2gpmoHKkNWr/NhzTliU6726D6RCypR+nw5tjpCm+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cost-and-usage-report-service/blob/refs/tags/3.85.0/LICENSE
```
