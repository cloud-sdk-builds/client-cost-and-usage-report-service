...
[`@aws-sdk/client-cost-and-usage-report-service`](https://www.npmjs.com/package/@aws-sdk/client-cost-and-usage-report-service/v/3.1110.0).
...
- @aws-sdk/client-cost-and-usage-report-service v3.1110.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cost-and-usage-report-service&version=3.1110.0](https://cloud-sdk-builds.github.io/?sdk=client-cost-and-usage-report-service&version=3.1110.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dT+A/jXhl8eF4oCiXanPwQilrbIHlgUaBAVl5sGe7hjFEIwC5PNVAtgbVSG+0wOf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cost-and-usage-report-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-and-usage-report-service@3.1110.0/index.min.mjs": "sha384-dT+A/jXhl8eF4oCiXanPwQilrbIHlgUaBAVl5sGe7hjFEIwC5PNVAtgbVSG+0wOf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cost-and-usage-report-service/blob/refs/tags/3.1110.0/LICENSE
```
